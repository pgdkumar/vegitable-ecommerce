          ...
          <div className="row g-5">
            <div className="col-lg-3 col-md-6">
              <div className="footer-item">
                ...
                <p className="mb-4">
                  Typesetting, remaining essentially unchanged. It was popularized in the 1960s with Aldus
          ...
          <div className="row">
            <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
              <span className="text-light">
                <a href="#"><i className="fas fa-copyright text-light me-2"></i>Your Site Name</a>, All rights reserved.
              </span>
            </div>
